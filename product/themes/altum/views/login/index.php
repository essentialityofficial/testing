...
<form action="" method="post" class="mt-4" role="form">
    ...
    <?php else: ?>
        ...
        <div class="form-group mt-4">
            <button type="submit" name="submit" class="btn btn-primary btn-lg btn-block my-1" <?= isset($_COOKIE['login_lockout']) ? 'disabled="disabled"' : null ?>><?= l('login.form.login') ?></button>
        </div>
    <?php endif ?>
