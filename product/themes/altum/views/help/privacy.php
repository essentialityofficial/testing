...
<h1 class="h4"><?= l('help.privacy.header') ?></h1>
...
<pre id="pixel_key_html" class="pre-custom rounded">&lt;script defer src="<?= url('pixel/12345678910111213') ?>" data-ignore-dnt="true"&gt&lt;/script&gt</pre>
