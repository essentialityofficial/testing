        ...
        <div class="card">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link <?= $data->type == 'sessions_events' ? 'active' : null ?>" href="<?= url('admin/statistics/sessions_events?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-seedling mr-1"></i> <?= l('admin_statistics.sessions_events.menu') ?></a>
