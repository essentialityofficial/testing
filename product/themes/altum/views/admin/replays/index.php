        ...
        <div class="ml-3">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/replays?' . $data->filters->get_get() . '&export=csv')  ?>" target="_blank" class="dropdown-item">
                        <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                    </a>
                    <a href="<?= url('admin/replays?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item">
        ...
        <table class="table table-custom">
            ...
            <?php foreach($data->replays as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= sprintf(l('replays.replay.expiration_date'), '<br />' . \Altum\Date::get($row->expiration_date, 2) . '<br /><small>' . \Altum\Date::get($row->expiration_date, 3) . '</small>') ?>">
                            <i class="fas fa-fw fa-calendar-times text-muted"></i>
                        </span>
