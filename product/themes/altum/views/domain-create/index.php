...
<?php endif ?>
    ...
    <div class="alert alert-secondary mb-4"><?= sprintf(l('domains.input.help'), '<strong>' . (settings()->analytics->domains_custom_main_ip ?: $_SERVER['SERVER_ADDR']) . '</strong>', '<strong>' . $host . '</strong>') ?></div>
