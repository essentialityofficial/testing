...
return [
    ...
    'global.plan_settings.sessions_events_retention' => '%s Days Data Retention for Pageviews',
    ...
    'dashboard.basic.no_data_help' => 'Did you properly install the Tracking Code?',
    ...
    'goal_create_modal.input.code_help' => 'This JavaScript snippet allows you to activate custom events within your web app.',
    ...
    'websites.usage' => 'Usage this month',
    ...
    'websites.input.domain_id_help' => 'Use a custom domain for your tracking code URL. Helpful to bypass ad-blockers.',
    'websites.input.host' => 'Website',
    'websites.input.host_help' => 'Tracking will only work on the <strong>domain.com</strong>, <strong>sub.domain.com</strong> or <strong>domain.com/path</strong> that you specify.',
    'websites.input.events_children_is_enabled' => 'Track visitors events',
    'websites.input.events_children_is_enabled_help' => 'Enable or disable tracking for mouse clicks, form submissions, resizes or scrolls.',
    'websites.input.sessions_replays_is_enabled' => 'Session replays',
    'websites.input.sessions_replays_is_enabled_help' => 'Enable or disable visual session replays tracking. This is a more advanced tracking type compared to the normal option.',
    'websites.input.email_reports_is_enabled_help' => 'Receive simple and easy to understand analytics for your site via email.',
    'websites.input.is_enabled' => 'Tracking status',
    'websites.input.is_enabled_help' => 'Fully enable or disable tracking of the website.',
    'websites.input.bot_exclusion_is_enabled' => 'Bot exclusion',
    'websites.input.bot_exclusion_is_enabled_help' => 'Exclude widely known bots from being tracked (ex: Google Bot, Yahoo Bot ...etc).',
    'websites.input.query_parameters_tracking_is_enabled' => 'Track query parameters',
    'websites.input.query_parameters_tracking_is_enabled_help' => 'Enabling this will allow query parameters to be tracked instead of ignored.',
    'websites.input.excluded_ips' => 'Excluded IPs',
    'websites.input.excluded_ips_help' => 'Exclude IPs from being tracked. Comma separated values.',
    ...
    'website_pixel_key_modal.install.subheader' => 'Copy and paste the following JS code snippet before the end of the <code>head</code> tag of your website.',
    ...
    'index.steps.two_text' => 'It\'s owned by you. you can fully delete it at any point.',
    ...
    'index.export.subheader' => 'Export your data to CSV or JSON with a click of a button.',
    ...
    'cron.email_reports.notice' => 'You received this email because you have enabled email reports in your %ssettings%s page.',
];
