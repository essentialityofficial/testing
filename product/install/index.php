                        ...
                        <section id="requirements" style="display: none">
                            ...
                            <div class="table-responsive table-custom-container mt-5">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                    <?php foreach(['config.php', 'uploads/main/', 'uploads/cache/', 'uploads/offline_payment_proofs/', 'uploads/blog/', 'uploads/pwa/', 'uploads/store/'] as $key): ?>
                                        <tr>
                                            <td>/<?= $key ?></td>
                        ...
                        <section id="setup" style="display: none">
                            ...
                            <form id="setup_form" method="post" action="" role="form">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="license_key" name="license_key" value="<?= $randomCode ?>" required="required">
                                </div>
